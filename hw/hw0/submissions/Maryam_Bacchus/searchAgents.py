...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state: Any):
        ...
        """
        "*** YOUR CODE HERE ***"
        #corners = [self.corners[0], self.corners[1], self.corners[2], self.corners[3]]
        #position, unvisited_nodes = state
    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                next_unvisited = unvisited_corners.copy()
                if next_position in next_unvisited:
                    next_unvisited.remove(next_position)

                successors.append(((next_position, next_unvisited), action, 1))
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    #    costs.append(util.manhattanDistance(position, food))
    #    max_food_dist = max(costs)
    #max_food_dist = 0
    #if len(foodList) > 1:
    #    for i, food1 in enumerate(foodList):
    #        for food2 in foodList[i+1:]:
    #            print("food1 is", food2)
    #            dist = util.manhattanDistance(food1, food2)
    #            max_food_dist = min(max_food_dist, dist)
